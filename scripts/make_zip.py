...
EXCLUDE_DIRS = {'.venv', 'venv', 'env', '__pycache__', '.pytest_cache', '.idea', '.vscode'}
EXCLUDE_FILES = {'db.sqlite3', 'repo.zip', '.DS_Store'}
...
def create_clean_repository_zip():
    ...
    print(f"Packaging clean repository zip from {repo_dir}...")
